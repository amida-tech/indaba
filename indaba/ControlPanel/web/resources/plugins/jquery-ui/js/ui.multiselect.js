...
(function($) {
    ...
    $.widget("ui.multiselect", {
        ...
        _create: function() {
            ...
            this.selectedActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><span class="count">0</span> <span class="counttxt">'+$.ui.multiselect.locale.itemsCount+'</span><a href="#" class="remove-all">'+$.ui.multiselect.locale.removeAll+'</a></div>').appendTo(this.selectedContainer);
