...
<html>
    <head>
        ...
        <title>Indaba Publisher - how to include Indaba Widget</title>
        <link type="text/css" rel="stylesheet" href="css/style.css"/>
        <script type="text/javascript" src="js/jquery-1.4.2.min.js"></script>
    </head>
    <body>
        <div id="indaba">
            <c:set var="active" value="widgethowto" scope="request"/>
            <jsp:include page="header.jsp" flush="true" />
            <link rel="stylesheet" href="css/widgetlibrary.css" />
            <link rel="stylesheet" href="widgets/css/howto.css" />
                ...
                <div class="wrapper">
                    <div id="widget">
                        ...
                        <dl>
                            ...
                            <dd>
                                Right click on this link: <a href="widgets/indaba_widget_helper.html">indaba_widget_helper.html</a>,
                            ...
                            <dd>
                                Right click on this link: <a href="widgets/indaba_widget.js">indaba_widget.js</a>,
                                            ...
                                            <ol style="margin-left:1.5em;">
                                                ...
                                                <li>Parsing <u>Permlink</u> to restore widgets content status<br/>
                                                    ...
                                                    <div id="permlink" style="display:none;">
                                                        ...
                                                        <p>Please check the <a href="widgets/sample/demo4.html">Permlink Demo</a> for live example.</p>
                                                    </div>
                                                </li>
                                            </ol>
                                        </li>
                    ...
                    <div id="sidebar">
                        <h2>Examples:</h2>
                        <ul>
                            <li><span class="ui-icon ui-icon-carat-1-e"></span><a href="widgets/sample/demo1.html">Demo 1</a></li>
                            <li><span class="ui-icon ui-icon-carat-1-e"></span><a href="widgets/sample/demo2.html">Demo 2</a></li>
                            <li><span class="ui-icon ui-icon-carat-1-e"></span><a href="widgets/sample/demo3.html">Demo 3</a></li>
                            <li><span class="ui-icon ui-icon-carat-1-e"></span><a href="widgets/sample/demo4.html">Permlink</a></li>
                        </ul>
                    </div>
                </div>
            </div>
