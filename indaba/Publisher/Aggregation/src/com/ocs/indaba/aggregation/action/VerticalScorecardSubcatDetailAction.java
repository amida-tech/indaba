...
import com.ocs.indaba.aggregation.json.VerticalScorecardSubcatDetailJsonUtils;
 ...
 * @author Jeff
 */
public class VerticalScorecardSubcatDetailAction extends BaseExportAction {

    private static final Logger log = Logger.getLogger(VerticalScorecardSubcatDetailAction.class);
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (scorecard != null) {
            JSONObject jsonObj = VerticalScorecardSubcatDetailJsonUtils.toJson(scorecard, subcatId);
