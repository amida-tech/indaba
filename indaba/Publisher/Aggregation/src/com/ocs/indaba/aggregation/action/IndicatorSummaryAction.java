 ...
 * @author Jeff
 */
public class IndicatorSummaryAction extends BaseExportAction {

    private static final Logger log = Logger.getLogger(IndicatorSummaryAction.class);
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        log.info("Get indicator summary - [horseId=" + horseId  + ", questionId=" + questionId+ ", version=" + version + " baseDir=" + baseDir
                + ", cacheDir=" + cacheDir + "] - " + genericLabel);
        
        JSONObject jsonObj = IndicatorSummaryJsonUtils.toJson(horseId, baseDir, cacheDir, genericLabel);
