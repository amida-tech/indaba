...
(function($) {
    ...
    var methods = {
        init: function(options) {
            var defaults = {
                ...
                alwaysShowScrollbar: true, /*always show scrollbar even when there's nothing to scroll (disables autoHideScrollbar): boolean*/
    ...
    $.event.special.mousewheel || document.write('<script src="plugins/scrollbar/js/jquery.mousewheel.js"><\/script>');
    /*plugin fn*/
