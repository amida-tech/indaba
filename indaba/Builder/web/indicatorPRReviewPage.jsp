...
<html>
    <head>
        ...
        <title><indaba:msg key='jsp.indicatorPRReviewPage.title' /></title>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                // load question list
                loadSurveyAnswerQuestionSidebar('${contextPath}', 'surveyAnswerPRReview.do', '${param.horseid}', '${param.assignid}', '0', '${view.surveyAnswerId}', '${param.returl}');
        ...
        <div class="wrapper">
            <div id="main-column">
                ...
                <jsp:include page="surveyAnswerReview.jsp" flush="true">
                    <jsp:param value="0" name="checkPermission" />
                    <jsp:param value="1" name="syncStatus"/>
                    <jsp:param value="1" name="folded"/>
                </jsp:include>
                ...
                <div align="center">
                    <c:choose>
                        <c:when test="${urlView.previousId == 0 || param.action == 'surveyReviewResponse.do'}">
                            <img src="images/icon_arrow_left_gray.png" alt=""/>
                        </c:when>
                        <c:otherwise>
                            <a class="nav-link" href="#" onclick="location.href = 'surveyAnswerPRReview.do?questionid=${urlView.previousId}&horseid=${param.horseid}&assignid=${param.assignid}&action=${param.action}&returl=${urlView.returnUrl}'"><img src="images/icon_arrow_left.png" alt=""/></a>
                            </c:otherwise>
                        </c:choose>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="large button blue icon-check" onclick="submitIndicatorPRReview(this, '${contextPath}', '${param.horseid}', '${param.assignid}', '${param.questionid}', ${view.referType}, ${view.answerType});"><indaba:msg key='common.btn.save' /></button>
                    <span id="saveComplete"></span>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <c:choose>
                        <c:when test="${urlView.nextId == 0 || param.action == 'surveyReviewResponse.do'}">
                            <img src="images/icon_arrow_right_gray.png" alt=""/>
                        </c:when>
                        <c:otherwise>
                            <a class="nav-link" href="#" onclick="location.href = 'surveyAnswerPRReview.do?questionid=${urlView.nextId}&horseid=${param.horseid}&assignid=${param.assignid}&action=${param.action}&returl=${urlView.returnUrl}'"><img src="images/icon_arrow_right.png" alt=""/></a>
                            </c:otherwise>
                        </c:choose>
                </div>
            </div>
            ...
            <div id="sidebar">
                <div id="sidebar_content">
                    ...
                    <jsp:include page="surveyAnswerNavigation.jsp" flush="true">
                        <jsp:param name="action" value="surveyAnswerPRReview.do"/>
                    ...
                    <jsp:include page="groupsSidebar.jsp" flush="true">
                        ...
                        <jsp:param value="14" name="taskType"/>
                    </jsp:include>
                    <div id="problem_list">
                        <%--
