...
<html>
                    ...
                    data: {
                        ...
                        success: function(data) {
                            if (data.flagId <= 0) {
                                ...
                                window.location.href = ctx + "/flagResponse.do?horseid=" + horseId + "&flagid=" + data.flagId +
    ...
    <body>
        ...
        <c:if test="${not empty contents && fn:contains(contents, 'B')}">
            <c:set var="disableScore" value="false" />
        </c:if>
        <c:set var="disableSource" value="true" />
        <c:if test="${not empty contents && fn:contains(contents, 'C')}">
            <c:set var="disableSource" value="false" />
        </c:if>
        <c:set var="disableComment" value="true" />
        <c:if test="${not empty contents && fn:contains(contents, 'D')}">
            <c:set var="disableComment" value="false" />
        </c:if>
        <c:set var="disableAttachment" value="true" />
        <c:if test="${not empty contents && fn:contains(contents, 'E')}">
            <c:set var="disableAttachment" value="false" />
        </c:if>
        ...
        <div id="indaba">
            ...
            <div class="wrapper">
                <div id="main-column">
                    ...
                    <jsp:include page="surveyAnswerPeerReviewsForFlagResponse.jsp" flush="true" >
                    ...
                    <div align="center" style="margin-bottom:10px;">
                        <a class="nav-link" title="Previous flag"
                           onclick="moveToFlag('${contextPath}', ${flagNavView.horseId}, ${flagNavView.flagId}, ${assignid}, '${flagNavView.exitUrl}', -1);">
                          <img src="images/icon_arrow_left.png" alt=""/>
                        </a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="large button blue icon-check" title="Save changes"
                            onclick="submitIndicatorFlagResponse(this, '${contextPath}', '${param.horseid}', ${assignid}, '${param.questionid}', ${surveyAnswerView.answerType}, ${surveyAnswerView.referType});">
                        <indaba:msg key='common.btn.save'/>
                    </button>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a class="nav-link" title="Next flag"
                           onclick="moveToFlag('${contextPath}', ${flagNavView.horseId}, ${flagNavView.flagId}, ${assignid}, '${flagNavView.exitUrl}', 1);">
                           <img src="images/icon_arrow_right.png" alt="Next flag"/>
                        </a>                        
                    </div>
                </div>
                <div id="sidebar">
                    <div id="sidebar_content">
                            ...
                            <jsp:include page="surveyAnswerActionBarFlagResponse.jsp" flush="true"/>
                        
                            <jsp:include page="surveyAnswerFlagResponseNavigation.jsp" flush="true">
                            ...
                            <jsp:include page="notesSidebar.jsp" flush="true" >
                                ...
                                <jsp:param value="20" name="taskType"/>
                            </jsp:include>
