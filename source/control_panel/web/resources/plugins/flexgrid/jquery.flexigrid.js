        ...
        var g = {
            ...
            addData: function (data) { //parse data
                ...
                if (p.total == 0) {
                    ...
                    var nodata='<div style="text-align: center; position: relative; vertical-height: middle; height: 26px; width: 100%;"></div>';
            ...
            for (var i = 0; i < p.colModel.length; i++) {
                ...
                if( cm ) {	// only use cm if its defined
                    ...
                    */
                    ...
                    if (cm.width) {
                        //alert(cm.display + ":::::::" + cm.name + "::::::::::" + cm.width);
            ...
            for (var i = 0; i < p.buttons.length; i++) {
                ...
                if (!btn.separator) {
                    ...
                    if (btn.bimage){ // if bimage defined, use its string as an image url for this buttons style (RS)
                        ...
                        btnimg = '<img src="'+btn.bimage+'" />';
                    }
                    btnDiv.innerHTML = ("<div><span>") +btnimg + (btn.hidename ? "</span><span class='label'>&nbsp;" : btn.name) + ("</span></div>");
                    ...
                    if(btn.attrs) {
                        for (var m = 0; m < btn.attrs.length; m++) {
                            $(btnDiv).attr(btn.attrs[m]['name'], btn.attrs[m]['value']);
                        }
                    }
                } else {
                    $(tDiv2).append("<div class='btnseparator hack-valign'></div>");
                }
            }
            $(g.tDiv).append(tDiv2);
            $(g.tDiv).append('<div '+(p.warnClass?'class="'+p.warnClass+'"':'')+'></div>');
