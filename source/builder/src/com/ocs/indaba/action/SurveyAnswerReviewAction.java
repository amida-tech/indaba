...
import static com.ocs.indaba.action.BaseAction.ATTR_ANSWER_ID;
...
public class SurveyAnswerReviewAction extends BaseAction {

    private static final Logger logger = Logger.getLogger(SurveyAnswerReviewAction.class);
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        //String strSurveyAnswerId = request.getParameter(PARAM_ANSWER_ID);
        ...
        SurveyAnswer answer = surveyService.getSurveyAnswerById(surveyAnswerId);
        request.setAttribute(PARAM_DISPLAY_HAVE_QUESTIONS, (answer.getReviewerHasProblem() == false));
