...
public class SurveyAnswerPeerReviewAction extends BaseAction {

    private static final Logger logger = Logger.getLogger(SurveyAnswerPeerReviewAction.class);
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        request.setAttribute("showIamDone", (completedAnswerCount == questionsCount));
        ...
        request.setAttribute("from", request.getParameter("action"));
        request.setAttribute("peerReview", reviewService.getSurveyPeerReview(loginUser.getPrjid(), loginUser.getUid(), surveyAnswerId));
