...
<html>
    <head>
        ...
        <title><indaba:msg key='jsp.journalReview.pagetitle' /></title>
        ...
        <div id="indaba">
            ...
            <div class="wrapper">
                ...
                <div align="center">
                    ...
                    <button class="large button blue icon-check" onclick="trySubmitDone('${contextPath}', '${param.horseid}', '${param.assignid}');">
                        <indaba:msg key='common.btn.donesubmit' /></button>
                        <%--
                                        <button class="iamdone" onclick="submitJournalAssignment('${contextPath}', '${param.horseid}', '${param.assignid}');"
                                                okButton="Submit" cancelButton="Cancel" prompt="Are you sure you have completed the assignment and want to submit now?"> <img src="images/check-white.png" alt=""/> I'm Done - Submit </button>
                        --%>
                </div>
            </div>
        </div>
