...
<html>
    <head>
        ...
        <title><indaba:msg key='jsp.journalPeerReview.pagetitle' /></title>
        ...
        <div id="indaba">
            ...
            <div class="wrapper">
                <jsp:include page="notebookView.jsp" flush="true">
                    ...
                    <jsp:param value="true" name="noreadonly"/>
                </jsp:include>

                <jsp:include page="peerReview.jsp" flush="true" >
                    <jsp:param value="1" name="syncStatus"/>
                </jsp:include>

                <div align="center">
                    <button class="iamdone large button blue icon-check" onclick="submitJournalPeerReview('${contextPath}', '${param.horseid}', '${param.assignid}');">
