 ...
 * @author yc06x
 */
public class FlagResponseAction extends BaseAction {
    ...
    private ActionForward getDirectedFlag(HttpServletResponse response, LoginUser loginUser, int horseId, FlagWorkView flag, int dir) {
        FlagWorkView flagView = commPanelService.getDirectedFlagAssignedToMe(loginUser, horseId, flag.getFlagId(), dir);
        if (flagView == null) {
