<%-- 
    Document   : export_doc_3
    Created on : 2011-2-27, 22:05:11
    Author     : Jeanbone
--%>
...
<html>
    ...
    <body onload="refresh_process_content('createJournalExport.do', 4)">
        <div id="indaba">
                        ...
                        <c:if test="${process_flag != null}">
                            <div id="export_Processing" >
                                <jsp:include page="export_processing.jsp" flush="true">
                                    <jsp:param name="zipFolder" value="journal_export_zip" />
                                </jsp:include>
                            </div>
                        </c:if>
                    </div>
