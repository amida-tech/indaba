 ...
 * @author yc06x
 */
public class IndicatorRefMappingReader extends Reader {

    static private final int COL_NAME = 0;
    static private final int COL_REF = 1;
    ...
    public IndicatorRefMappingReader(ProcessContext ctx, File file) {
    ...
    public void read() {
        ...
        while ((line = readNext()) != null) {
            ...
            String ref = super.getColumn(line, COL_REF);

            ctx.setIndicatorRefMapping(name, ref);
        }
    }
