 ...
 * @author yc06x
 */
public class ProjectNameMappingReader extends Reader {
    ...
    public ProjectNameMappingReader(ProcessContext ctx, File file) {
    ...
    public void read() {
        ...
        while ((line = readNext()) != null) {
            ...
            ctx.setProjectNameMapping(oldName, newName);
        }
    }
